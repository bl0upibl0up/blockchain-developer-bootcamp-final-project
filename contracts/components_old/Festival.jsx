...
class Festival extends Component {
  ...
  onCreateFestival = async (e) => {
    try {
      ...
      const { events: { Created: { returnValues: { ntfAddress, marketplaceAddress } } } } = await festivalMarketPlace.methods.createNewFest(
        festivalMarketToken._address,
        name,
        symbol,
      ...
      const nftInstance = await festivalTicket(ntfAddress);
